...
-   Moving average and adjust logic to utilize it

### Updated

-   buy & sell to utilize an owned boolean
-   live poc to no longer log theory data

## [0.11.2] - 2021-03-08

### Updated

-   Initialization to use historica data or "interval" amount of tickers
-   refactored buy/sell to be exponential based on account asset & base amounts

## [0.11.1] - 2021-03-08

### Updated

-   coinData.previous to include 5 previous ticks
-   coinData to capture volume, v from OHLCV endpoint
-   ping to be just be current tick

## [0.11.0] - 2021-03-08

### Added

-   Created pocLive which buys/sells via API and stores data
...
[0.11.0]: https://github.com/JesseChamberlain/binance-trader/compare/v0.10.0...v0.11.0
